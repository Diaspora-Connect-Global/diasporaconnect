...
export function EmbassyEventDetail({ eventId, community, profile }: EmbassyEventDetailProps) {
  ...
  async function submitRegistration(formResponsesJson?: string) {
    ...
    try {
      ...
      // Map the backend "not accepting registrations" guard to a friendly toast;
      // fall back to the generic failure for anything else.
  ...
  async function handleCancel() {
    ...
    try {
      await cancelMutation({ variables: { registrationId: event.myRegistrationId } });
