            ...
            <tbody className="bg-white divide-y divide-gray-100">
              {products.map((Service) => (
                <tr key={Service.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">{Service.inventory}</td>
                  <td className="px-6 py-4 text-sm text-gray-600">{getLocalizedCategory(Service.category)}</td>
